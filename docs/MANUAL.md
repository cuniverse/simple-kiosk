...
- **GitHub 이슈 리포트**에서 분류·제목·문제 설명·재현 방법·기대 결과를 작성하면 프로그램 버전과 Windows 환경이 자동으로 포함된 GitHub 새 이슈 화면이 열립니다. GitHub 로그인 후 내용을 확인하고 최종 등록하며, 상세 로그가 필요하면 진단 보고서를 별도로 첨부합니다.
