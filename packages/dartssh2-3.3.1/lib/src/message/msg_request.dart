...
class SSH_Message_Global_Request extends SSHMessage {
  ...
  /// OpenSSH stream-local forwarding socket path.
  ...
  /// Request remote forwarding of a Unix domain socket.
  factory SSH_Message_Global_Request.streamLocalForward(String socketPath) {
    return SSH_Message_Global_Request(
  ...
  /// Request cancellation of a remote Unix domain socket forwarding.
  factory SSH_Message_Global_Request.cancelStreamLocalForward(
    String socketPath,
  ) {
    return SSH_Message_Global_Request(
  ...
  String toString() {
    switch (requestName) {
      ...
      case 'streamlocal-forward@openssh.com':
      case 'cancel-streamlocal-forward@openssh.com':
        return 'SSH_Message_Global_Request(requestName: $requestName, wantReply: $wantReply, socketPath: $socketPath)';
      // case 'hostkeys-00@openssh.com':
