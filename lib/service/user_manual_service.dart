...
const userManualRepositoryBase =
    'https://github.com/cuniverse/simple-kiosk/blob/main/';
const userManualRepositoryDocsBase = '${userManualRepositoryBase}docs/';

/// Markdown 매뉴얼을 앱 내부 WebView에서 표시할 수 있는 HTML 문서로 만든다.
String buildUserManualHtml(String markdownSource) {
  ...
  body = body.replaceAllMapped(
    RegExp(r'href="\.\./([^"#]+)(#[^"]*)?"'),
    (match) =>
        'href="$userManualRepositoryBase${match.group(1)}${match.group(2) ?? ''}"',
  );
  return _htmlDocument(body);
}
